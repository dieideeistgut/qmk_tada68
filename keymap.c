...
=======
[_BL] = KEYMAP_ANSI(
>>>>>>> dieideeistguts tada68 changeset
=======
[_BL] = LAYOUT_ansi(
>>>>>>> change to LAYOUT_ansi too
=======
[_BL] = KEYMAP_ANSI(
>>>>>>> dieideeistguts tada68 changeset
...
>>>>>>> dieideeistguts tada68 changeset
  ...
  _______,_______, KC_UP,KC_EJCT,_______, _______,_______,_______,_______,_______,_______,_______,_______, _______,KC_HOME, \
